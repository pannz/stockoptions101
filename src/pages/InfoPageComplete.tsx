            ...
            <div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-blue-800">
                  <strong>{t('info.sections.options.what_are.example').split(':')[0]}:</strong> {t('info.sections.options.what_are.example').split(':')[1]}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-medium">{t('info.sections.options.vesting.year1').split(':')[0]}</span>
                  <span className="text-gray-600">{t('info.sections.options.vesting.year1')}</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2 my-2">
                  <div className="bg-primary-600 h-2 rounded-full" style={{ width: '0%' }}></div>
                </div>
                <div className="flex justify-between text-sm text-gray-600">
                  <span>{t('info.sections.options.vesting.year2')}</span>
                  <span>{t('info.sections.options.vesting.year3')}</span>
                  <span>{t('info.sections.options.vesting.year4')}</span>
                  <span>{t('info.sections.options.vesting.year5')}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <p className="text-green-800">
                  <strong>{t('info.sections.rsu.what_are.key_difference').split(':')[0]}:</strong> {t('info.sections.rsu.what_are.key_difference').split(':')[1]}
                </p>
              </div>
            </div>
